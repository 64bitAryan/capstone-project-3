  ...
  return (
    <div className='flex flex-col md:flex-row w-4/5 justify-between items-center mx-auto py-10'>
      <div className='md:w-3/6 w-full '>
        ...
        <div className='flex mt-5'>
             <button className='shadow-xl shadow-black text-white bg-[#e32970] hover:bg-[#bd255f] rounded-full p-2'>Create NFT
             </button>
        </div>
    ...
    <div className='shadow-xl shadow-black md:w-2/5 w-full mt-10 md:mt-0 rounded-md overflow-hidden bg-gray-800'>
        ...
        <div className='flex justify-start items-center p-3'>
            <Identicon className='h-10 w-10 object-contain rounded-full mr-3' string={'0x21..2116a'} size={50} />
            <div>
                <p className='text-white font-semibold'>0x21..2116a</p>
                <small className='text-yellow-400 font-bold'>@iampikachu</small>
            </div>
        </div>
    </div>
